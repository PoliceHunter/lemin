...
=======
/*   Updated: 2020/11/14 01:11:44 by ksean            ###   ########.fr       */
>>>>>>> fdd96a6ea0a59f07e027c1a5ec41e6e0398b377f
/*                                                                            */
/* ************************************************************************** */
...
t_node							*find_or_insert(t_vector *vec,
								const char *new_node);
int								find_in_vec(t_vector *vec, const char *name);
t_node							*find_and_get(t_vector *vec, char *name);
...
void							push_back_node_vec(t_vector *vec, t_node node);
void							push_front_node_vec(t_vector *vec, t_node node);
void							emplace_back_node_vec(t_vector *vec,
								t_node node);

void							printf_node_vec(t_vector *vec);
void							emplace_front_node_vec(t_vector *vec,
								t_node node);
int								insert_into_node_vec(t_vector *vec,
...
int								is_sorted(t_vector vec);
int								ft_is_digitstr(const char *str);
void							parse_line(char *line, t_help *help,
								t_vector *vec);

char							*process_file(const char *filename,
								t_vector *vec);
int								check_room(char *line, t_help *help);
int								check_duplicate_links(t_node_ptr src,
								t_node_ptr dst);
int								it_is_link(const char *line);
int								empty_string(const char *line, t_help *help);
int								find_comment(const char *line);
